...
class eliminarGrupo(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Eliminar Grupo", font=("Arial",11), fg="white", bg="#089970")
        ...
        tituloC = Label(subFrame, text="Criterio", font=("Arial", 11), fg="white", bg="#089970")
        tituloC.grid(row=0, column=0, padx=10, pady=8)

        tituloV = Label(subFrame, text="Valor", font=("Arial", 11), fg="white", bg="#089970")
        tituloV.grid(row=0, column=1, padx=10, pady=8)

        textoM = Label(subFrame, text="Materia", font=("Arial", 11), fg="white", bg="#089970" )
        ...
        textoM = Label(subFrame, text="Grupo", font=("Arial", 11), fg="white", bg="#089970")
        ...
        botonEliminar = Button(subFrame, text="Eliminar", command=botEliminar, font=("Arial", 11), fg="white", bg="#089970")
        botonEliminar.grid(row=3, column=0, padx=10, pady=10, sticky='e')

        botonLimpiar = Button(subFrame, text="Limpiar", command=limpiar, font=("Arial", 11), fg="white", bg="#089970")
