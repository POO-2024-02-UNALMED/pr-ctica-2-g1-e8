...
class agregarMateria(Frame):
    def __iniy__(self, ventana):
        ...
        def siguiente():
            try:
                ...
                if nPrer > 0:
                    ...
                    subFrame.pack()
                    tituloC = Label(subFrame, text="Criterio", font=("Arial", 11), fg="white", bg="#089970", padx=5, pady=5)
                    ...
                    bAgregar = Button(subFrame, text="Agregar materia", command=finalizarP, font=("Arial", 11), fg="white", bg="#089970")
                    bAgregar.grid(row=len(boxes)+1, column=0, padx=10, pady=10, sticky='e')

                    bLimpiar = Button(subFrame, text="Limpiar", command=limpiar2, font=("Arial", 11), fg="white", bg="#089970")
        ...
        titulo = Label(self, text="Agregar Materia", font=("Arial", 14), fg="white", bg="#089970")
        ...
        creditosL = Label(sFrame, text="Créditos", font=("Arial", 11), fg="white", bg="#089970")
        ...
        prerrequisitosL = Label(sFrame, text="# Prerrequisitos", font=("Arial", 11), fg="white", bg="#089970")
        ...
        facuL = Label(sFrame, text="Facultad", font=("Arial", 11), fg="white", bg="#089970")
