...
class GenerarHorario(Frame):
    def __init__(self,ventana):
        ...
        self.pack()
        self.config(bg="#cedae0",highlightbackground="#089970",highlightthickness=5)
        
        

        titulo = Label(self, text="Generar Horario", font=("Arial", 14,"bold"),fg="#cedae0",bg="#089970",wraplength=410,highlightbackground="#089970",highlightthickness=2)
...
class RecoleccionDat(Frame):
    def __init__(self,ventana):
            ...
            MidIzq=Frame(FrameCont,height=340,width=268,bg="#089970")
            ...
            bontonFiltro=Button(MidIzq,text="Filtrar",command=genFiltro,state="disabled",bg="#cedae0",font=("arial",11),fg="#089970")
            ...
            fraBotones=Frame(MidDer,bg="#089970")
            ...
            bottEliminarUltima = Button(fraBotones,text="Eliminar Ultima",command=eliminarUltima,bg="#cedae0",font=("arial",11),fg="#089970")
            bottEliminarUltima.pack(side="left",padx=10,pady=10)
            
            bottLimpiar = Button(fraBotones,text="Eliminar todas",command=eliminarTodas,bg="#cedae0",font=("arial",11),fg="#089970")
            bottLimpiar.pack(side="left",padx=10,pady=10)
        
            bottGenerar = Button(fraBotones,text="Generar",command=generar,bg="#cedae0",font=("arial",11),fg="#089970")
...
class horarioGenerado(Frame):
    def __init__(self,ventana,horarioAMostrar):
        ...
        FrameCont2 = Frame(self,bg="#089970",width=855,height=310)
        ...
        fraBotones=Frame(self,bg="#089970",height=60)
        ...
        bottDescartar = Button(fraBotones,text="Descartar",command=descartar,bg="#cedae0",font=("arial",11),fg="#089970")
        bottDescartar.pack(side="left",padx=10,pady=(3,1))        

        bottConservar = Button(fraBotones,text="Asignar",command=asignar,bg="#cedae0",font=("arial",11),fg="#089970")
        ...
        textAsig = Label(fraBotones,text="Conservar y asignar a: ",bg="#cedae0",font=("arial",11),fg="#089970")
