...
¡Esperamos que disfrutes de nuestra aplicación y tengas un exitoso período académico!
        ...
        def mostrarAutores():
            autores = (
                ...
                + "Jhoan Rua Garcia\n\n"
                + "Lina Sanchez Morales\n\n"
                + "Stiven Rosero Quemag\n\n"
                + "Sergio Morales Martinez"
            )
        ...
        bienvenida_label = Label(frame, text="¡Bienvenido a la ventana principal de Z.I.A!", font=("Arial", 14), fg="white", bg="#089970")
        ...
        info_text = Label(frame, text=informacion, font=("Arial", 10), fg="white",bg="#089970")
