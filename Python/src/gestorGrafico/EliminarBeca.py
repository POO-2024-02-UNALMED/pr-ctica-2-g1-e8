...
class EliminarBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Eliminar Beca", bg="#cedae0", foreground="#089970", font=("Helvetica", 14, "bold"))
        ...
        boton = Button(self, text="Eliminar Beca", command=confEliminar, font=("Arial", 11, "bold"), fg="white", bg="#089970")
        boton.pack()
