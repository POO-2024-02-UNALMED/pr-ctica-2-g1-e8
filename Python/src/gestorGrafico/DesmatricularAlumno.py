...
class DesmatricularAlumno(Frame):
    def __init__(self,ventana):
        ...
        titulo = Label(self, text="Desmatricular Alumno", font=("Arial", 14), fg="white", bg="#089970")
        ...
        descripcion = Button(self, text=textDescripcion, font=("Arial", 10), fg="white", bg="#089970")
        descripcion.pack(anchor="n", pady=20)

        frame = Frame(self, bg="#cedae0")
        frame.pack(padx=5, pady=5)

        nombre = Label(frame, text="Elija como quiere seleccionar el alumno", font=("Arial", 14), fg="white", bg="#089970")
        nombre.pack(side="top", anchor="n", pady=20)

        opcion1 = Button(frame, text="Ver la lista de estudiantes", font=("Arial", 10), fg="white", bg="#089970", command=listaEstudiantes)
        opcion1.pack(side="left", pady=20, padx=10)

        opcion2 = Button(frame, text="Buscar estudiante por ID (Documento) y nombre", font=("Arial", 10), fg="white", bg="#089970", command=buscarEstudiante)
...
class AlumnoPorLista(Frame):
    def __init__(self,ventana):
        ...
        def seleccionMateria(event):
                ...
                self._materiaSeleccionada = Label(der, text=infoMateria, font=("Arial", 10),bg="#089970")
        ...
        def desmatricularDelSistema():
            ...
            self._estudianteSeleccionado = None
            messagebox.showinfo("Estudiante desmatriculado", "El estudiante ha sido desmatriculado del sistema con éxito")
        ...
        def desmatricularMateria():
            ...
            titulo2 = Label(der, text="Desmatricular de Materia", font=("Arial", 14), bg="#089970")
            ...
            botonDesmatricular = Button(der, text="Desmatricular", font=("Arial", 10), command=desmatricularGrupo, bg="#089970", fg="white")
        ...
        izq=Frame(ventana, height=460,width=250, bg="#089970")
        izq.pack(side="left", anchor="e")
        izq.pack_propagate(False)

        atras = Button(izq, text="Atras", font=("Arial", 10), bg="#cedae0", fg="#089970", command=retroceder)
        ...
        subFrame = Frame(der, highlightbackground="#089970", highlightthickness=3)
        subFrame.pack(padx=5, pady=5, expand=True)

        titulo = Label(subFrame, text="Desmatricular Alumno", font=("Arial", 14), fg="white", bg="#089970")
        titulo.pack(side="top", anchor="center", pady=10, padx=5)

        text = "Seleccione de qué quiere desmatricular al estudiante"

        descripcion = Label(subFrame, text=text, font=("Arial", 10), fg="white", bg="#089970")
        descripcion.pack(pady=10, padx=5)

        desmatricular1 = Button(subFrame, text="Desmatricular del sistema", font=("Arial", 10), fg="white", bg="#089970", command=desmatricularDelSistema)
        desmatricular1.pack(pady=20, padx=5)

        desmatricular2 = Button(subFrame, text="Desmatricular de una materia", font=("Arial", 10), fg="white", bg="#089970", command=desmatricularMateria)
...
class AlumnoPorBusqueda(Frame):
    ...
    def __init__(self,ventana):
        ...
        def seleccionMateria(event):
                ...
                infoMateria = "Materia seleccionada: " + nombreMateria + "\n"
                infoMateria += "Información del grupo:\n"
                infoMateria += "Número: " + str(grupo.getNumero()) + "\n"
                infoMateria += "Profesor: " + grupo.getProfesor().getNombre()
        ...
        def desmatricularMateria():
            ...
            titulo2 = Label(der, text="Desmatricular de Materia", font=("Arial", 14), fg="white", bg="#089970")
            titulo2.pack(side="top", anchor="center", padx=10, pady=10)
            ...
            botonDesmatricular = Button(der, text="Desmatricular", font=("Arial", 10), fg="white", bg="#089970", command=desmatricularGrupo)
            botonDesmatricular.pack(side="bottom", anchor="center", pady=10)
        ...
        acept = Button(frame, text="Buscar", font=("Arial", 10), fg="white", bg="#089970", command=buscarEstudiante)
        acept.pack(side="left", anchor="ne", padx=10, pady=10)

        borrar = Button(frame, text="Borrar", font=("Arial", 10), fg="white", bg="#089970", command=limpiar)
