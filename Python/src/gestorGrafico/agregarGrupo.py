    ...
    def __init__(self, ventana):
        ...
        def siguiente():
            try:
                ...
                diaL = Label(subFrame, text="Día", font=("Arial", 11), fg="white", bg="#089970")
                diaL.grid(row=0, column=0, padx=10, pady=8)

                hiL = Label(subFrame, text="Hora Inicio", font=("Arial", 11), fg="white", bg="#089970")
                hiL.grid(row=0, column=1, padx=10, pady=8)

                hfL = Label(subFrame, text="Hora Final", font=("Arial", 11), fg="white", bg="#089970")
                ...
                bAgregar = Button(otroFrame, text="Agregar grupo", command=agregar, font=("Arial", 11), fg="white", bg="#089970")
                bAgregar.grid(row=sesiones+1, column=0, padx=10, pady=10, sticky='e')

                bLimpiar = Button(otroFrame, text="Limpiar", command=limpiar2, font=("Arial", 11), fg="white", bg="#089970")
        ...
        titulo = Label(self, text="Agregar Grupo", font=("Arial", 14),  fg="white", bg="#089970")
        ...
        descripcion = Label(self, text=texto, font=("Arial", 11), fg="white", bg="#089970")
        descripcion.pack(anchor="n", pady=20, padx=5)

        sFrame = Frame(self, bg="#cedae0")
        sFrame.pack(padx=5, pady=5)

        tituloC = Label(sFrame, text="Criterios", font=("Arial", 11), fg="white", bg="#089970")
        tituloC.grid(row=0, column=0, padx=10, pady=8)

        tituloV = Label(sFrame, text="Valores", font=("Arial", 11), fg="white", bg="#089970")
        tituloV.grid(row=0, column=1, padx=10, pady=8)

        mateL = Label(sFrame, text="Materia", font=("Arial", 11), fg="white", bg="#089970")
        ...
        profeL = Label(sFrame, text="Profesor", font=("Arial", 11), fg="white", bg="#089970")
        ...
        cuposL = Label(sFrame, text="Cupos", font=("Arial", 11), fg="white", bg="#089970")
        cuposL.grid(row=3, column=0, padx=10, pady=8)
        cuposE = Entry(sFrame, font=("Arial", 11))
        cuposE.grid(row=3, column=1, padx=10, pady=8)

        salonL = Label(sFrame, text="Salón", font=("Arial", 11), fg="white", bg="#089970")
        ...
        sesionesL = Label(sFrame, text="# Sesiones de clase", font=("Arial", 11), fg="white", bg="#089970")
        ...
        botonSiguiente = Button(sFrame, text="Siguiente", command=siguiente, font=("Arial", 11), fg="white", bg="#089970")
        botonSiguiente.grid(row=6, column=0, padx=10, pady=10, sticky='e')

        botonLimpiar = Button(sFrame, text="Limpiar", command=limpiar1, font=("Arial", 11), fg="white", bg="#089970")
