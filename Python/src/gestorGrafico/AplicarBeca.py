...
class AplicarBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Aplicar Beca a Estudiante", bg="#cedae0", foreground="#089970", font=("Helvetica", 14, "bold"))
        ...
        boton = Button(self, text="Aplicar Beca", command=asigBeca, font=("Arial", 11, "bold"), fg="white", bg="#089970")
        boton.pack()
