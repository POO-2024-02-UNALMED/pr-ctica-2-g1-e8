...
class CrearBeca(Frame):
    def __init__(self, ventana):
        ...
        titulo = Label(self, text="Crear Beca", bg="#cedae0", foreground="#089970", font=("Helvetica", 14, "bold"))
        ...
        crit = Label(creandoBeca, text="Criterios", font=("Arial", 11, "bold"), fg="#089970", bg="#cedae0")
        crit.grid(row=0, column=0, padx=10, pady=10)

        val = Label(creandoBeca, text="Valores", font=("Arial", 11, "bold"), fg="#089970", bg="#cedae0")
        val.grid(row=0, column=1, padx=10, pady=5)

        cuposL = Label(creandoBeca, text="Cupos", font=("Arial", 11), fg="#089970", bg="#cedae0")
        cuposL.grid(row=1, column=0, padx=10, pady=5)
        cuposE = Entry(creandoBeca, font=("Arial", 11))
        cuposE.grid(row=1, column=1, padx=10, pady=5)
        
        nombreL = Label(creandoBeca, text="Nombre", font=("Arial", 11), fg="#089970", bg="#cedae0")
        ...
        promedioL = Label(creandoBeca, text="Promedio requerido", font=("Arial", 11), fg="#089970", bg="#cedae0")
        ...
        avanceL = Label(creandoBeca, text="Avance requerido", font=("Arial", 11), fg="#089970", bg="#cedae0")
        ...
        estratoL = Label(creandoBeca, text="Estrato máximo\n para aplicar", font=("Arial", 11), fg="#089970", bg="#cedae0")
