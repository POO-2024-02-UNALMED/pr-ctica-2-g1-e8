...
class PostulacionBecas(Frame):
    def __init__(self,ventana):
        ...
        tituloenventana = Label(self, text="Búsqueda y Postulación de Becas", bg="#089970", foreground="#cedae0", font=("Helvetica", 14, "bold"))
        ...
        mostrarB = Button(seleccion, text="Mostrar listado de becas", foreground="white",background="#089970",font=("Helvetica", 12), command= mostrarBeca)
        mostrarB.grid(row=0,column=0,padx=20,pady=10,sticky="w")

        aplicarB = Button(seleccion, text="Aplicar beca a estudiante", foreground="white",background="#089970",font=("Helvetica", 12), command= aplicarBeca)
        aplicarB.grid(row=0,column=1,padx=10,pady=10,sticky="w")

        crearB = Button(seleccion, text="Crear nueva beca", foreground="white",background="#089970",font=("Helvetica", 12), command= becaNueva)
        crearB.grid(row=1,column=0,padx=45,pady=10,sticky="w")

        eliminarB = Button(seleccion, text="Eliminar beca", foreground="white",background="#089970",font=("Helvetica", 12), command= eliminarBeca)
